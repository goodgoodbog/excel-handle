...
class Extract_Merge_plus:
    ...
    def work(self):
        ...
        # 最终列
        last_column1 = {'客户单号', '服务商单号', '运输方式', '目的国家', '发件人公司名', '发件人姓名', '发件人省/州',
                        '发件人城市', '发件人地址', '发件人电话', '发件人邮箱', '发件人邮编', '发件人传真',
                        '收件人公司名', '收件人姓名', '收件人省/州', '收件人城市', '收件人地址', '收件人门牌号',
                        '收件人护照号码', '收件人电话', '收件人手机', '收件人邮箱', '收件人邮编', '收件人传真',
                        '买家id', 'vat号码', '交易id', '保险类型', '保险价值', '投保人', '投保人身份证', '货物名称',
                        '包装与数量', '订单备注', '重量', '是否带电池', '是否需要签名服务', '是否退件', '是否单独报关',
                        '包裹种类', 'eori号码', '代收货款金额', '代收货款币种', '分销商编码', '运费', 'ioss号码',
                        '申报保险费', '运费/申报保险费/商品申报币种', '海关报关品名1', '海关申报品名（中）1', '配货信息1',
                        '申报价值1', '申报品url1', '申报品数量1', '海关货物编号1', '配货备注1', '海关报关品名2',
                        '海关申报品名（中）2', '配货信息2', '申报价值2', '申报品url2', '申报品数量2', '海关货物编号2',
                        '配货备注2', '海关报关品名3', '海关申报品名（中）3', '配货信息3', '申报价值3', '申报品url3',
                        '申报品数量3', '海关货物编号3', '配货备注3', '海关报关品名4', '海关申报品名（中）4', '配货信息4',
                        '申报价值4', '申报品url4', '申报品数量4', '海关货物编号4', '配货备注4', '海关报关品名5',
                        '海关申报品名（中）5', '配货信息5', '申报价值5', '申报品url5', '申报品数量5', '海关货物编号5',
                        '配货备注5'}
        # 最终列
        last_column2 = ['客户单号', '服务商单号', '运输方式', '目的国家', '发件人公司名', '发件人姓名', '发件人省/州',
                        '发件人城市', '发件人地址', '发件人电话', '发件人邮箱', '发件人邮编', '发件人传真',
                        '收件人公司名', '收件人姓名', '收件人省/州', '收件人城市', '收件人地址', '收件人门牌号',
                        '收件人护照号码', '收件人电话', '收件人手机', '收件人邮箱', '收件人邮编', '收件人传真',
                        '买家id', 'vat号码', '交易id', '保险类型', '保险价值', '投保人', '投保人身份证', '货物名称',
        ...
        need_column = last_column1.difference(set(df1.columns))
